        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <ScrollReveal>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-8">
              ...
              <span className="text-sm text-primary font-medium">Prêt à transformer votre entreprise ?</span>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.2}>
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
              Que vous soyez une startup, une PME ou une grande entreprise, nous vous aidons à passer 
              de l'idée à l'agent intelligent opérationnel, rapidement et efficacement.
            </p>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.3}>
            <div className="p-6 rounded-2xl bg-card/50 border border-border/50 mb-10 max-w-2xl mx-auto">
              <p className="text-foreground text-lg font-medium italic">
                "L'intelligence artificielle n'est plus un concept, c'est un levier stratégique."
              </p>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.5}>
            <div className="mt-12 pt-8 border-t border-border/30">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center text-sm">
                <a href="mailto:contact@agentia.fr" className="text-primary hover:text-primary/80 transition-colors">
                  contact@agentia.fr
                </a>
                <span className="hidden sm:block text-border">•</span>
                <a href="tel:+33123456789" className="text-primary hover:text-primary/80 transition-colors">
                  +33 1 23 45 67 89
                </a>
              </div>
            </div>
