...
const services = [
  {
    ...
    description: "Exploitez vos bases de connaissances internes pour fournir des réponses fiables, contextualisées et à jour.",
    features: ["Documents internes", "FAQ dynamiques", "Bases métiers"],
  },
  {
    icon: MessageSquare,
    title: "Agents d'assistance intelligente",
    description: "Des assistants IA capables de répondre aux questions, assister vos équipes et améliorer l'expérience utilisateur 24/7.",
    features: ["Support client", "Assistance RH/IT", "Commerce"],
  },
  {
    icon: Calendar,
    title: "Gestion intelligente des rendez-vous",
    description: "Automatisez la prise, la modification et le suivi des rendez-vous grâce à des agents capables de dialoguer naturellement.",
    features: ["Dialogue naturel", "Sync agendas", "Réduction tâches"],
  },
  {
    icon: Cog,
    title: "Automatisation de processus",
    description: "Orchestrez des workflows complets : collecte d'informations, analyse, prise de décision et action automatisée.",
